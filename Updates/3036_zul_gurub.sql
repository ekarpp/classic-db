...
DELETE FROM creature_movement WHERE id=51388;
...
DELETE FROM dbscripts_on_creature_movement WHERE id>1134000 AND id<1134100;
...
DELETE FROM creature_linking WHERE master_guid=51388;
...
DELETE FROM creature_movement WHERE id=49034;
...
DELETE FROM creature_movement_template WHERE entry=11359;
...
DELETE FROM creature_movement WHERE id=51424;
...
DELETE FROM dbscripts_on_creature_movement WHERE id>1135900 AND id<1136000;
...
DELETE FROM creature_linking WHERE master_guid=51424;
INSERT INTO creature_linking (guid, master_guid, flag) VALUES
(51425, 51424, 1539),
(51426, 51424, 1539);
...
DELETE FROM creature_movement WHERE id=51403;
INSERT INTO creature_movement (id, point, position_x, position_y, position_z, orientation, waittime, script_id) VALUES
...
DELETE FROM creature_linking WHERE master_guid=51403;
INSERT INTO creature_linking (guid, master_guid, flag) VALUES
(51414, 51403, 1539),
(51415, 51403, 1539),
(51416, 51403, 1539),
...
DELETE FROM creature_movement WHERE id=49033;
INSERT INTO creature_movement (id, point, position_x, position_y, position_z) VALUES
...
DELETE FROM creature_movement WHERE id=51427;
INSERT INTO creature_movement (id, point, position_x, position_y, position_z, waittime, script_id) VALUES
...
DELETE FROM creature_linking WHERE master_guid=51427;
INSERT INTO creature_linking (guid, master_guid, flag) VALUES
(51428, 51427, 1539),
(51429, 51427, 1539);
